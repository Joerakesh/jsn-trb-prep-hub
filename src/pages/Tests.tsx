...
import { Clock, FileText, Users, ExternalLink, Play, Search, Filter } from "lucide-react";
...
const Tests = () => {
  ...
  const filteredTests = tests.filter(test => {
    ...
    const matchesDifficulty = selectedDifficulty === 'all' || test.difficulty.toLowerCase() === selectedDifficulty;
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center">
            <Badge variant="secondary" className="text-blue-600 bg-white px-4 py-2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-4 text-blue-600">Before Starting</h3>
              ...
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-4 text-green-600">During the Test</h3>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start">
